    ...
    int choice2 = 0;
       ...
       do {
            if (player.getLevel() < 5)
            {
                ...
                Monster[] monsters = {bulbasaur, squirtle, charmander};
        ...
        if (player.getLevel() < 10 && player.getLevel() >= 5)
            ...
            JOptionPane.showMessageDialog(null, "you encounter a wild " + operational.getName());
                ...
                do {
                    ...
                    if (player.getSpeed() < operational.getSpeed())
                    {
                        System.out.println("You attack second. Your opponents HP is: ");
                        int z = 0;
                        z = fight.doAttack(player.getAttack(), operational.getHealth());
                        operational.setHealth(z);
                        if (operational.getHealth() < 0)
                    ...
                    {
                        JOptionPane.showMessageDialog(null, "the battle is still going");
                    }
        ...
        String option2 = JOptionPane.showInputDialog("do you want to battle more? (1 for no, 2 for yes)");
